...
$data = mysqli_fetch_all(mysqli_query($conn, $offices), MYSQLI_ASSOC);
                            ...
                            <tbody>
                                <?php foreach ($data as $table_row) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo $table_row['contact_no']; ?></td>
                                        <td><?php echo $table_row['email']; ?></td>
                                        <td><?php echo $table_row['address']; ?></td>
                                        <td><?php echo $table_row['city']; ?></td>
                                        <td><?php echo $table_row['country']; ?></td>
                                        <td><?php echo $table_row['postal']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
